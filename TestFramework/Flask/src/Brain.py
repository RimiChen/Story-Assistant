...
class Brain(object):
    ...
    def intersect(self, other):
        return [v for k,v in self.assertions.items() if other.has_assertion(v)]
    ...
    def get_assertions_related_to(self, concept):
        ...
        for k,a in self.assertions.items():
            ...
            for prop, value in a.__dict__.items():
...
def delete_old_assertions(path):
    userInput = input("\n delete all assertion files y/n? \n")
